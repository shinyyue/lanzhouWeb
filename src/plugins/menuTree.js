var faisunMenu_openedfolderimage_src = "src/images/openedfolder.gif";
var faisunMenu_closedfolderimage_src = "src/images/closedfolder.gif";
var faisunMenu_menufileimage_src = "src/images/menufile.gif";
...
// document.write("<style type='text/css'>.blockhide{display:block;} .blockmove{overflow: hidden;height:1px;display:block;} .blockshow{overflow: visible; display:none;} .hideme{overflow: visible;display:none;} .showme{overflow: visible;display:block;} .faisunMenu td{font-size:10pt;} </style>");
...
function showhideit(itemNo) {
    ...
    var subfiles = document.getElementById("item" + itemNo);
    if (subfiles.className == "blockmove") {
        return;
    }
...
function createtree(elemId) {
    ...
    document.getElementById(elemId).innerHTML = echo
